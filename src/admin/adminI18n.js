...
const fr = {
  ...
  "reputation.description":
    "Examinez les avis signalés et appliquez uniquement les décisions de modération prévues.",
  "reputation.open": "À traiter",
  "reputation.history": "Historique",
  "reputation.empty_open": "Aucun avis signalé n’attend une décision.",
  "reputation.empty_history": "Aucune décision de modération enregistrée.",
