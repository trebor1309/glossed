    ...
    <Routes>
      <Route element={<AdminLayout />}>
        ...
        <Route
          path="verifications"
          element={
            <PermissionRoute permission="verification.read">
        ...
        <Route
          path="missions"
          element={
            <PermissionRoute permission="missions.read">
              <AdminMissionsPage />
            </PermissionRoute>
          }
        />
        ...
        <Route
          path="litiges"
          element={
            <PermissionRoute permission="disputes.read">
              <AdminDisputesPage />
            </PermissionRoute>
          }
        />
        <Route
          path="litiges/:caseType/:caseId"
          element={
            <PermissionRoute permission="disputes.read">
        ...
        />
        <Route
          path="finance/paiements/:paymentId"
          element={
            <PermissionRoute permission="finance.read">
              <AdminFinancialPaymentDetailPage />
            </PermissionRoute>
          }
        />
        <Route
          path="risque"
          element={
            <PermissionRoute permission="risk.read">
              <AdminPaymentDisputesPage />
            </PermissionRoute>
          }
        />
        <Route
          path="risque/:disputeId"
          element={
            <PermissionRoute permission="risk.read">
              <AdminPaymentDisputeDetailPage />
            </PermissionRoute>
          }
        />
        <Route
        ...
        <Route
          path="configuration"
          element={
            <PermissionRoute permission="configuration.read">
        ...
        <Route
          ...
          element={
            <PermissionRoute permission="administrators.read">
      ...
      <main className="flex min-h-screen items-center justify-center bg-slate-950 px-4 text-white">
        <div className="max-w-md text-center">
          ...
          <p className="mt-3 text-sm text-slate-400">
            L’administration Glossed est accessible uniquement depuis son domaine dédié.
          </p>
        </div>
      </main>
    );
