...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-amber-50 to-white text-gray-900 font-sans">
      ...
      {/* Hero */}
      <section className="relative flex flex-col md:flex-row items-center justify-between px-6 md:px-16 py-24 md:py-32 min-h-screen overflow-hidden bg-gradient-to-br from-amber-50 via-white to-rose-50">
        <div
    ...
    bg-cover bg-center opacity-40 "
        ...
        <div className="relative z-10 max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-16">
          {/* Text content */}
          <motion.div
          ...
          >
            <div className="inline-block px-4 py-2 bg-rose-100 text-rose-700 rounded-full text-sm font-medium mb-6 shadow-sm">
            ...
            >
              <a
                href="#"
                className="bg-gradient-to-r from-rose-600 to-red-600 text-white px-8 py-4 rounded-full font-semibold hover:shadow-xl hover:scale-105 transition-all duration-300 text-center"
              >
                Book now
              </a>
              <a
                href="#"
                className="text-gray-700 font-semibold hover:text-rose-600 transition-all duration-300 flex items-center justify-center gap-2 px-8 py-4 hover:shadow-xl hover:scale-105 border border-gray-200 rounded-full hover:border-rose-300"
              >
                Learn more →
              </a>
            </motion.div>
            ...
            <motion.div
              className="flex items-center justify-center md:justify-start gap-6 text-sm text-gray-500 mt-10"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          {/* Hero image */}
          <motion.div
            className="relative mt-16 md:mt-0 group" // ← ajout de .group ici
          ...
          >
            ...
            <motion.img
              ...
              className="relative rounded-3xl shadow-2xl max-w-sm md:max-w-md transform transition-transform duration-700 ease-out group-hover:scale-105"
            />

            {/* Reflet glossy au survol */}
            <div className="absolute inset-0 rounded-3xl bg-gradient-to-tr from-white/25 via-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 ease-out"></div>
